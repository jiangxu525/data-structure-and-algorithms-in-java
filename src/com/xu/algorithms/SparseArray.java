 ...
 * @Description: algorithm for creating sparse array
 * @author Xu
 * @date 2020-06-07 11:16:31
 */
public class SparseArray {
	...
	public static void main(String[] args) {
		...
		/**
		 * create the sparse array 1st row: the total row number, total column number,
		 * total nonzero cells in the chessArray n row: row number of the value, column
		 * number of the value,the value e.g. value 1 is in arr[1][2] so that: 1 2 1
		 */
